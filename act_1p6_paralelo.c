...
int main()
{
    char nombre1[25] = "Runge1_paral.txt";
    char nombre2[25] = "Runge2_paral.txt";
    char nombre3[25] = "Runge3_paral.txt";
    char nombre4[25] = "Runge4_paral.txt";   
    ...
    #pragma omp parallel
    {
        ...
        {
            #pragma omp section
                (void) rungekuta(mi_N, nombre1, 1);
            #pragma omp section
                (void) rungekuta(mi_N, nombre2, 2);
            #pragma omp section
                (void) rungekuta(mi_N, nombre3, 3);
            #pragma omp section
                (void) rungekuta(mi_N, nombre4, 4);
        }
    }
